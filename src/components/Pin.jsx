    ...
    return (
        <div className='m-2'>
            ...
            <img className='rounded-lg w-full' alt='user-post' src={(urlFor(image).width(250).url())}/>
                {postHovered && (
                    <div
                        className='absolute top-0 w-full h-full flex flex-col justify-between p-1 pr-2 pb-2 x-50'
                        style={{ height: '100%' }}
                    >
                        ...
                        <div className='flex justify-between items-center gap-2 w-full'>
                            {destination && (
                                <a
                                    ...
                                    target='_blank'
                                    rel='noreferrer'
                                    className='bg-white flex items-center gap-2 text-black font-bold p-2 pi-4 pr-4 rounded-full opacity-70 hover:100 hover:shadow-md '
                                >
